...
<script>
  ...
  />
        ...
        <section style={{backgroundColor:"#F4F6F6"}}>
            <h2 className="justify-content-center d-flex">700+ Clients</h2>
            <div className="marquee-wrapper" style={{backgroundColor:"#F4F6F6"}}>
              <div className="marquee">
                ...
                {/* Duplicate for seamless loop Add comment More actions */}
                <div className="marquee-group">
                  {logos.map((src, idx) => (
